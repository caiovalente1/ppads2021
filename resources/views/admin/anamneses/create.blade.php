...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.anamnese.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.anamneses.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <div class="form-check {{ $errors->has('air') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="air" value="0">
                    <input class="form-check-input" type="checkbox" name="air" id="air" value="1" {{ old('air', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('tiredness') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="tiredness" id="tiredness" value="1" {{ old('tiredness', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('fever') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="fever" id="fever" value="1" {{ old('fever', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('pain') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="pain" id="pain" value="1" {{ old('pain', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('head') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="head" id="head" value="1" {{ old('head', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('chest') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="chest" id="chest" value="1" {{ old('chest', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('muscle') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="muscle" id="muscle" value="1" {{ old('muscle', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('smell') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="smell" id="smell" value="1" {{ old('smell', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('taste') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="taste" id="taste" value="1" {{ old('taste', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('diarrhea') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="diarrhea" id="diarrhea" value="1" {{ old('diarrhea', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('sneeze') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="sneeze" id="sneeze" value="1" {{ old('sneeze', 0) == 1 ? 'checked' : '' }}>
