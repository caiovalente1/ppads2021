...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.healtState.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.healt-states.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <div class="form-check {{ $errors->has('good') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="good" value="0">
                    <input class="form-check-input" type="checkbox" name="good" id="good" value="1" {{ old('good', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('bad') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="bad" id="bad" value="1" {{ old('bad', 0) == 1 ? 'checked' : '' }}>
